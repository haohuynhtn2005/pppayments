...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <p class="bold">Please check your payment method and try again, or <a href="<?php echo $contact_page_link ?>" class="bold">contact</a> support if you need assistance.</p>
