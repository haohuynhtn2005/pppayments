...
class Item
{
     ...
     */
    public function __construct(string $name, Money $unit_amount, int $quantity, string $description = '', ?Money $tax = null, string $sku = '', string $category = 'PHYSICAL_GOODS', string $url = '', string $image_url = '', float $tax_rate = 0, ?string $cart_item_key = null, ?int $product_id = null, ?Money $discount = null)
    {
        $this->name = $name;
